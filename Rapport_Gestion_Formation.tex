...
\caption{Dashboard Admin --- Onglet Vue d'ensemble : 4 cartes de statistiques, filtrage par ann\'{e}e, camembert par domaine, top 5 formations, participants les plus actifs et formateurs}
\label{fig:dash1}
\end{figure}
...
\caption{Dashboard Admin --- Onglet Gouvernance \& Budget : courbe d'\'{e}volution du budget avec zoom interactif et barres par domaine}
\label{fig:dash2}
\end{figure}

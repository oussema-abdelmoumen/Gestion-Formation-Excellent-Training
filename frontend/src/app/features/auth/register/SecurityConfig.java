    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // ── FORMATIONS : RESPONSABLE+ADMIN CRUD | UTILISATEUR GET only ──
                .requestMatchers(HttpMethod.GET,    "/api/formations/**").hasAnyRole("ADMIN","RESPONSABLE","UTILISATEUR")
                .requestMatchers(HttpMethod.POST,   "/api/formations/**").hasAnyRole("ADMIN","RESPONSABLE")
                .requestMatchers(HttpMethod.PUT,    "/api/formations/**").hasAnyRole("ADMIN","RESPONSABLE")
                .requestMatchers(HttpMethod.DELETE, "/api/formations/**").hasAnyRole("ADMIN","RESPONSABLE")
